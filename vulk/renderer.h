...
//    vulk_rd_appinfo.pApplicationInfo= "Alsami Game Engine - Vulkan";
    ...
    if(vkCreateInstance(&Renderer_Create_Info,nullptr,/*instance to return value to*/&rederer_vulk_inst)!=VK_SUCCESS) {
      APP_QUIT();
      vulkanlogger_alsami(0,"ERROR: FAILED TO CREATE VULKAN INSTANCE. THIS IS A PREVIEW BUILD. MORE DETAILED LOGGING WILL COME SOON");
    }
  }
  void dInitInstance(){
  ...
  void InitDevice(){
    ...
    vkGetDeviceQueue(a_device, vulk_graphics_family_index, 0, &a_queue);
